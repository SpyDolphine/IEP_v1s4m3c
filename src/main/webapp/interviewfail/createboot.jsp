  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <p class="modal-title" id="myModalLabel"><h4>취업 실패 후기 작성 게시판
         <span class="glyphicon glyphicon-inbox"></span></h4></p>
      </div>
      
      <FORM name='frm' method='POST' action='./createboot.do'> 
      ...
      <div>
        <label for='if_gender'>성별</label>&nbsp;
          <input type='radio' name='if_gender' id='if_gender' value='남자' checked> 남자
      ...
      <div>
        <label for='if_exper'>면접경험</label>&nbsp;
          <input type='radio' name='if_exper' id='if_exper' value='잘 모르겠다' checked> 잘 모르겠다
      ...
      <div>
        <label for='if_where'>취업경로</label>&nbsp;
          <input type='radio' name='if_where' id='if_where' value='온라인지원' checked> 온라인지원
      ...
      <div>
        <label for='if_how'>채용방식</label>&nbsp;
          <input type='radio' name='if_how' id='if_how' value='인/적성검사' checked> 인/적성검사
      ...
      <div>
        ...
        <input type='text' name='if_when' id='if_when' value='발표시기' required="required">
      </div>        
