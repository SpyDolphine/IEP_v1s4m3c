...
<FORM name='frm' method='POST' action='./update.do'>
  <input type="hidden" id='rno' name="rno" value="${failreplyVO.rno }"> 
    ...
    ${failreplyVO.rcontent }</textarea>
    <ul>
    <li class='right'>
    <button type="submit" id='submit' class="btn btn-success btn-xs" style='float:right; margin: 5px;'>
    <i class="fa fa-edit"></i> 수정</button>
    <button type="button" class="btn btn-info btn-xs" style='float:right; margin: 5px;' onclick="location.href='./replylist.do?if_no=${failreplyVO.if_no}'">
