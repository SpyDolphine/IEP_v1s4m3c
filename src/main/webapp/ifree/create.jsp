   ...
   <fieldset>
    <ul>
      <li>
        ...
        <input type='text' name='cm_title' id='cm_title' value='정보를 공유합니다' size='60' required="required">
      </li>
      <li>
        <label for='cm_nick'>닉네임</label>
        <input type='text' name='cm_nick' id='cm_nick' value='정보수니' size='60' required="required">
      </li>
      <li>
        <label for='cm_content'>내용</label>
        <textarea name='cm_content' id='cm_content'  rows='5' cols='70'>좋은정보 감사감사 댓글부탁</textarea>
      </li>
      <li>
