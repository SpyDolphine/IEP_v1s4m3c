...
ct_entry              varchar2(200) null,            -- 공모전 참가자격
ct_enter              varchar2(200) null,           -- 접수방법
ct_award            varchar2(200) null,            -- 시상자격
ct_startdate        varchar2(200) null,            -- 접수 시작일
ct_enddate        varchar2(200) null,             -- 접수 마감일
ct_daydate        varchar2(200) null,             -- 접수 마감일
ct_statedate       varchar2(200) null,            -- 발표 일
ct_url                varchar2(200)  null,           -- 공모전 관련 홈페이지
  ...
  FROM(
      select ct_no, ct_title, ct_host, ct_startdate, ct_enddate, ct_daydate, ct_cnt, ct_file2, ct_file1, ct_size2
         ...
         SELECT ct_no, ct_title, ct_host, ct_startdate, ct_enddate, ct_daydate, ct_cnt, ct_file2, ct_file1, ct_size2 
           ...
           SELECT ct_no, ct_title, ct_host, ct_startdate, ct_enddate, ct_daydate, ct_cnt, ct_file2, ct_file1, ct_size2 as r
           FROM(
                    SELECT ct_no, ct_title, ct_host, ct_startdate, ct_enddate, ct_daydate, ct_cnt, ct_file2, ct_file1, ct_size2
                    FROM iep_contest
                    WHERE  ct_title LIKE '%' || '메롱' || '%' )
