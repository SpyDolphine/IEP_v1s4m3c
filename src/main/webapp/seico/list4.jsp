    ...
    <table class="table table-striped" style='width: 100%;'>
      ...
      <tbody>
       ...
       <%--     <c:choose>
              ...
              <a href="./read.do?sc_no=${vo.sc_no}&col=${searchDTO.col}&word=${searchDTO.word}&nowPage=${searchDTO.nowPage}">${vo.sc_title}</a> 
            </td> 
            ...
            <td style='vertical-align: middle;'>
              ...
              <a href="./delete.do?sc_no=${vo.sc_no}<%-- &divisionno=${vo.divisionno} --%>"><img src="./images/delete.png" title="삭제"  border='0'/></a>
            </td>
